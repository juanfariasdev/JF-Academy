...
export type CourseManyWhereInput = {
  ...
  /** All values that are contained in given list. */
  courseType_in?: InputMaybe<Array<CourseType>>;
  /** All values that are not equal to given value. */
  courseType_not?: InputMaybe<CourseType>;
  /** All values that are not contained in given list. */
  courseType_not_in?: InputMaybe<Array<CourseType>>;
  createdAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  createdAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
  ...
  tumbnailUrl?: InputMaybe<Scalars['String']>;
  /** All values containing the given string. */
  tumbnailUrl_contains?: InputMaybe<Scalars['String']>;
  /** All values ending with the given string. */
  tumbnailUrl_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are contained in given list. */
  tumbnailUrl_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values that are not equal to given value. */
  tumbnailUrl_not?: InputMaybe<Scalars['String']>;
  /** All values not containing the given string. */
  tumbnailUrl_not_contains?: InputMaybe<Scalars['String']>;
  /** All values not ending with the given string */
  tumbnailUrl_not_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are not contained in given list. */
  tumbnailUrl_not_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values not starting with the given string. */
  tumbnailUrl_not_starts_with?: InputMaybe<Scalars['String']>;
  /** All values starting with the given string. */
  tumbnailUrl_starts_with?: InputMaybe<Scalars['String']>;
  updatedAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  updatedAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
...
export enum CourseOrderByInput {
  ...
  TumbnailUrlAsc = 'tumbnailUrl_ASC',
  TumbnailUrlDesc = 'tumbnailUrl_DESC',
  UpdatedAtAsc = 'updatedAt_ASC',
  UpdatedAtDesc = 'updatedAt_DESC'
}
...
export type TeacherCreateInput = {
  avatarURL: Scalars['String'];
  bio: Scalars['String'];
  course?: InputMaybe<CourseCreateManyInlineInput>;
  createdAt?: InputMaybe<Scalars['DateTime']>;
  name: Scalars['String'];
  updatedAt?: InputMaybe<Scalars['DateTime']>;
};
...
export type TeacherManyWhereInput = {
  ...
  course_every?: InputMaybe<CourseWhereInput>;
  course_none?: InputMaybe<CourseWhereInput>;
  course_some?: InputMaybe<CourseWhereInput>;
  createdAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  createdAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
...
export type TeacherUpdateInput = {
  avatarURL?: InputMaybe<Scalars['String']>;
  bio?: InputMaybe<Scalars['String']>;
  course?: InputMaybe<CourseUpdateManyInlineInput>;
  name?: InputMaybe<Scalars['String']>;
};
...
export type GetCoursesQuery = { __typename?: 'Query', courses: Array<{ __typename?: 'Course', title: string, slug: string, tumbnailUrl: string, teachers: Array<{ __typename?: 'Teacher', avatarURL: string, name: string }> }> };

export type GetLessonByCourseSlugQueryVariables = Exact<{
  slug?: InputMaybe<Scalars['String']>;
}>;


export type GetLessonByCourseSlugQuery = { __typename?: 'Query', course?: { __typename?: 'Course', lessons: Array<{ __typename?: 'Lesson', id: string, slug: string, title: string, availableAt?: any | null, lessonType: LessonType }> } | null };
...
export type GetLessonBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', title: string, description?: string | null, videoId: string, availableAt?: any | null, course?: { __typename?: 'Course', teachers: Array<{ __typename?: 'Teacher', id: string, avatarURL: string, name: string, bio: string }> } | null } | null };


export const CreateSubscriberDocument = gql`
    mutation CreateSubscriber($name: String!, $phone: String, $email: String!) {
  createSubscriber(data: {name: $name, phoneNumber: $phone, email: $email}) {
    id
  }
}
    `;
...
export const GetLessonByCourseSlugDocument = gql`
...
/**
 * __useGetLessonByCourseSlugQuery__
 *
 * To run a query within a React component, call `useGetLessonByCourseSlugQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetLessonByCourseSlugQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetLessonByCourseSlugQuery({
 *   variables: {
 *      slug: // value for 'slug'
 *   },
 * });
 */
export function useGetLessonByCourseSlugQuery(baseOptions?: Apollo.QueryHookOptions<GetLessonByCourseSlugQuery, GetLessonByCourseSlugQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetLessonByCourseSlugQuery, GetLessonByCourseSlugQueryVariables>(GetLessonByCourseSlugDocument, options);
      }
export function useGetLessonByCourseSlugLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetLessonByCourseSlugQuery, GetLessonByCourseSlugQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetLessonByCourseSlugQuery, GetLessonByCourseSlugQueryVariables>(GetLessonByCourseSlugDocument, options);
        }
export type GetLessonByCourseSlugQueryHookResult = ReturnType<typeof useGetLessonByCourseSlugQuery>;
export type GetLessonByCourseSlugLazyQueryHookResult = ReturnType<typeof useGetLessonByCourseSlugLazyQuery>;
export type GetLessonByCourseSlugQueryResult = Apollo.QueryResult<GetLessonByCourseSlugQuery, GetLessonByCourseSlugQueryVariables>;
